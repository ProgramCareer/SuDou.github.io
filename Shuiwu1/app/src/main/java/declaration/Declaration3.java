...
public class Declaration3 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_declaration3);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Declaration3.this, Quhao.class);
            ...
            public void run() {
                try{
                    ...
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=213")
                            .build();
        ...
        new  Thread(new Runnable() {
            ...
            public void run() {
                try{
                    OkHttpClient client = new OkHttpClient();
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=214")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData =response.body().string();
                    News1(responseData);
        ...
        new  Thread(new Runnable() {
            ...
            public void run() {
                try{
                    OkHttpClient client = new OkHttpClient();
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=215")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData =response.body().string();
                    News3(responseData);
        ...
        new  Thread(new Runnable() {
            ...
            public void run() {
                try{
                    OkHttpClient client = new OkHttpClient();
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=216")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData =response.body().string();
                    News4(responseData);
