...
public class Invoice1 extends Activity implements  View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Invoice1.this, Quhao.class);
            ...
            public void run() {
                try{
                    ...
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=307")
                            .build();
        ...
        new  Thread(new Runnable() {
            ...
            public void run() {
                try{
                    OkHttpClient client = new OkHttpClient();
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=308")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData =response.body().string();
                    News1(responseData);
        ...
        new  Thread(new Runnable() {
            ...
            public void run() {
                try{
                    OkHttpClient client = new OkHttpClient();
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=309")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData =response.body().string();
                    News3(responseData);
        ...
        new  Thread(new Runnable() {
            ...
            public void run() {
                try{
                    OkHttpClient client = new OkHttpClient();
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=310")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData =response.body().string();
                    News4(responseData);
