...
public class Invoice extends Activity implements View.OnClickListener{
    ...
    Button first,second,third,fource,fifth,sixth;
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Invoice.this, Quhao.class);
            ...
            public void run() {
                try{
                    ...
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=301")
                            .build();
        ...
        new  Thread(new Runnable() {
            ...
            public void run() {
                try{
                    OkHttpClient client = new OkHttpClient();
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=302")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData =response.body().string();
                    News1(responseData);
        ...
        new  Thread(new Runnable() {
            ...
            public void run() {
                try{
                    OkHttpClient client = new OkHttpClient();
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=303")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData =response.body().string();
                    News3(responseData);
        ...
        new  Thread(new Runnable() {
            ...
            public void run() {
                try{
                    OkHttpClient client = new OkHttpClient();
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=304")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData =response.body().string();
                    News4(responseData);
        ...
        new  Thread(new Runnable() {
            ...
            public void run() {
                try{
                    OkHttpClient client = new OkHttpClient();
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=305")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData =response.body().string();
                    News5(responseData);
        ...
        new  Thread(new Runnable() {
            ...
            public void run() {
                try{
                    OkHttpClient client = new OkHttpClient();
                    Request request =new Request.Builder()
                            .url("http://47.94.195.37:8080/BankLeader/getData?id=306")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData =response.body().string();
                    News6(responseData);
