...
<div class="menu">
    <ul class="clearfix">
        <li class="hover"><a href="${ctx}/sys/home.action">工作主页</a></li>
        <li><a href="${ctx}/report/reportservice_getReportServiceData.action">统计报表</a></li>
        <li><a href="${ctx}/xwzc/xwzcinfo_newsUI.action">新闻政策</a></li>
